      ...
      , Ot = function () {
         return new Promise(function (t) {
            ...
            Tt.restoreFocusTimeout = setTimeout(function () {
               Tt.previousActiveElement && Tt.previousActiveElement.focus ? (Tt.previousActiveElement.focus(),
                  Tt.previousActiveElement = null) : document.body && document.body.focus(),
                  t()
            }, 100),
      ...
      , Ht = Object.freeze({
         ...
         queue: function (t) {
            ...
            return new Promise(function (i) {
               !function e(n, o) {
                  n < Et.length ? (document.body.setAttribute("data-swal2-queue-step", n),
   ...
   function ne(t) {
      ...
      null !== t.onBeforeOpen && "function" == typeof t.onBeforeOpen && t.onBeforeOpen(n),
         ...
         dt && j(n) ? (e.style.overflowY = "hidden",
            n.addEventListener(dt, ee.bind(null, n, e))) : e.style.overflowY = "auto",
         ...
         st() || Tt.previousActiveElement || (Tt.previousActiveElement = document.activeElement),
      ...
      _main: function (t) {
         ...
         !function (t) {
            for (var e in t)
               At(i = e) || y('Unknown parameter "'.concat(i, '"')),
                  t.toast && (o = e,
                     -1 !== qt.indexOf(o) && y('The parameter "'.concat(o, '" is incompatible with toasts'))),
         ...
         return new Promise(function (t) {
            ...
            Ft.swalPromiseResolve.set(c, t),
               l.timer && (Tt.timeout = new Gt(function () {
                  s("timer"),
                     delete Tt.timeout
               }
                  , l.timer));
            ...
            Tt.keydownTarget && Tt.keydownHandlerAdded && (Tt.keydownTarget.removeEventListener("keydown", Tt.keydownHandler, {
               ...
               Tt.keydownHandlerAdded = !1),
               l.toast || (Tt.keydownHandler = function (t) {
                  return function (t, e) {
